...
class SupplierNotifier
    extends
        AutoDisposeFamilyAsyncNotifier<BaseResponse<Supplier>, String?> {
  int _page = 1;
  bool _loadingMore = false;

  @override
  Future<BaseResponse<Supplier>> build(String? type) async {
    _page = 1;
    final search = ref.watch(supplierSearchProvider);
    final useCase = ref.read(getMasterDataListUseCaseProvider);

    return await useCase.callSuppliersPaginated(
      type: type,
