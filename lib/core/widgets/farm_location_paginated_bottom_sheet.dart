...
class FarmLocationPaginatedBottomSheet extends ConsumerStatefulWidget {
  ...
  const FarmLocationPaginatedBottomSheet({
    super.key,
  ...
  @override
  ConsumerState<FarmLocationPaginatedBottomSheet> createState() =>
      _FarmLocationPaginatedBottomSheetState();
}

class _FarmLocationPaginatedBottomSheetState
    extends ConsumerState<FarmLocationPaginatedBottomSheet> {
  ...
  void initState() {
    ...
    _scrollController.addListener(() {
      if (_scrollController.position.pixels >=
        ...
        ref.read(paginatedFarmLocationProvider.notifier).loadMore();
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    final asyncData = ref.watch(paginatedFarmLocationProvider);
            ...
            TextField(
              onChanged: (val) {
                ...
                _debounce = Timer(const Duration(milliseconds: 500), () {
                  ref.read(farmLocationSearchProvider.notifier).state = val;
                });
              },
