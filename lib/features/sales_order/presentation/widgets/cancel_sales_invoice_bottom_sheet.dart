...
class CancelSalesInvoiceBottomSheet extends ConsumerStatefulWidget {
  final Function(ChartOfAccount?) onConfirm;

  const CancelSalesInvoiceBottomSheet({super.key, required this.onConfirm});

  @override
  ConsumerState<CancelSalesInvoiceBottomSheet> createState() =>
      _CancelSalesInvoiceBottomSheetState();
}

class _CancelSalesInvoiceBottomSheetState
    extends ConsumerState<CancelSalesInvoiceBottomSheet> {
  String _searchQuery = '';
      ...
      child: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Text(
                "Tandai Nota Penjualan Sebagai Dibatalkan",
                style: AppTypography.mediumBoldBlack,
                textAlign: TextAlign.center,
              ),
              const SizedBox(height: 8),
              const Text(
                "Apakah Anda yakin ingin menandai Nota Penjualan ini sebagai dibatalkan? Tindakan ini tidak dapat dibatalkan.",
              ...
              ConstrainedBox(
                ...
                child: ref
                    .watch(chartOfAccountListProvider)
                    .when(
                      data: (accounts) {
