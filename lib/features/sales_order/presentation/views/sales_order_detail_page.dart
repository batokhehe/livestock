      ...
      children: [
        SectionCard(
          children: [
            ...
            //   TwoColumnRowCard(
            //     leftValue: 'Rp ${formatPrice(data.priceUnit)}',
            //     leftLabel: "Harga/kg Forecast",
            //     rightValue: 'Rp ${formatPrice(data.priceSubtotal)}',
            ...
            Row(
              ...
              children: [
                Text(
                  detailData.isForecast == 'yes' ? "Total Forecast" : "Total",
