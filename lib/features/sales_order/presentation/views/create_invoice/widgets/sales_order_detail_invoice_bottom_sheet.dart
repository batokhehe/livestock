            ...
            child: Column(
              children: [
                ...
                _buildValueRow(
                  ...
                  value2: "Rp ${formatPrice(orderItem.netTotal)}",
                ),
              ],
            ),
          ),
      ...
      child: Column(
        children: [
          _buildInfoRow(
            ...
            title: "Rp ${formatPrice(orderItem.netTotal)}",
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          _buildPricingRow("Subtotal", "Rp ${formatPrice(item.calculatedSubtotal)}"),
          const SizedBox(height: 8),
          _buildPricingRow("Diskon", "Rp ${formatPrice(item.calculatedDiscountTotal)}"),
          const Divider(height: 24, color: AppColors.fieldBorder),
          _buildPricingRow(
            "Total Keseluruhan",
            "Rp ${formatPrice(item.calculatedAmountTotal)}",
            isBold: true,
