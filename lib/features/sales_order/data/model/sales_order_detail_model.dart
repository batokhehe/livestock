...
class SalesOrderDetail {
  ...
  factory SalesOrderDetail.fromJson(Map<String, dynamic> json) {
    return SalesOrderDetail(
      ...
      farmLocationId: json['farm_location_id'] ?? (json['farm_location'] is Map ? json['farm_location']['id'] : null),
      farmAreaId: json['farm_area_id'] ?? (json['farm_area'] is Map ? json['farm_area']['id'] : null),
