...
class PurchaseInvoiceDetailBottomSheet extends StatelessWidget {
  final PurchaseInvoice invoice;

  const PurchaseInvoiceDetailBottomSheet({super.key, required this.invoice});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoRow("Pesanan Pembelian", invoice.orderId ?? '-'),
          _buildInfoRow("Nama Supplier", invoice.supplierName ?? '-'),
