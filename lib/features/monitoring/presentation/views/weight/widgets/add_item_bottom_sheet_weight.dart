...
class AddItemBottomSheetWeight extends ConsumerStatefulWidget {
  final List<int> excludedIds;
  const AddItemBottomSheetWeight({super.key, this.excludedIds = const []});

  @override
  ConsumerState<AddItemBottomSheetWeight> createState() =>
      _AddItemBottomSheetWeightState();
}

class _AddItemBottomSheetWeightState
    extends ConsumerState<AddItemBottomSheetWeight> {
