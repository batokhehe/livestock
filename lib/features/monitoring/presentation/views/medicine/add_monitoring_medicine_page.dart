...
class AddMonitoringMedicinePage extends StatelessWidget {
  const AddMonitoringMedicinePage({super.key});
      ...
      children: [
        SelectField(
          ...
          onTap: () async {
            ...
            if (pickedDate != null) {
              ref.read(selectedMedicineMonitoringDateProvider.notifier).state =
                  pickedDate;
            }
          },
        ),
      ...
      child: Padding(
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            ...
            onPressed: isValid
                ? () {
                    context.push('/monitoring/add/step-2?type=medicine');
                  }
                : null,
