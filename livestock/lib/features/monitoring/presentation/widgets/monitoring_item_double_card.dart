...
class MonitoringItemDoubleCard extends StatelessWidget {
  final Monitoring item;

  const MonitoringItemDoubleCard({super.key, required this.item});
  ...
  Widget build(BuildContext context) {
    ...
    final String statusText = isReceived ? 'Dikonfirmasi' : 'Menunggu';
